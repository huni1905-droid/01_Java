	...
	public static void main(String[] args) {
	  ...
	  // 자료형   변수명;
		...
		booleanData=true;//booleanData 변수에 true 논리값 대입.
		                 //여기서 또 boolean 자료형을 붙이지 않는다.
		                 //이미 만들어진 booleanData란 상자를 또 만들고 거기에 true를 넣겠다는 말이 된다.
		//값을 변수에 최초로 대입 --> 초기화
		
		System.out.println("booleanData : " + booleanData);
		
		byte byteData; // 변수의 선언
		//메모리에 정주값을 저장할 공간을 1byte 할당하고
		...
		//--> 100억이란 값은 int 의 범위를 벗어났다.
		//--> 리터럴값 자체를 int 로 인식하고 있다.
		//--> 왜? 우리가 int 형 리터럴 표기법으로 100억을 나타냈기 때문
		...
		int int_Number; // 자바는 카멜케이스 사용
						// _ 작성 표기법은 DB에서 사용
						// 자바의 상수에서 사용 ex)PI_VALUE
		
		// 5. 카멜표기법 사용(맨 처음 소문자 시작, 후속 단어 첫글자 대문자)
		char helloWorldAppleBananaTomato;
		
		// 6. 변수명은 언어를 가리지 않는다.(한글로도 가능하지만 관례상 쓰지 않는다.)
		 ...
		 * - 상수의 명명 규칙 : 모두 대문자, 단어 구분시 _ 사용
		 * 
		 * - 상수를 사용하는 경우
		 * 1) 변하면 안되는 고정된 값을 저장할 때 ex. pi
