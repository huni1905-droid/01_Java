...
public class ClsService /*extends Student*/{
	...
	// * 상속받으면 부모의 것도 마치 내것처럼 이용!*
	//System.out.println( v1 ); // public 가능
	//System.out.println( v2 ); // protected 가능
	//System.out.println( v3 ); // (default) 다른 패키지라서 안된다
	//System.out.println( v4 ); // 해당클래스 내부가 아닌 다른 클래서라서 안된다
	...
	public void ex2() {
		...
		// *** static의 가장 큰 특징 : 
		//Student std1 = new Student();와 같은 객체를 만들지 않아도
		//클래스 이름으로 값에 바로 접근 가능 ***
