...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// Arrays.toString(배열명); // 메서드// -> String 형
	...
	public void ex2() {
		...
		arr[3] = 400;
		//arr[4] = 400;
		// java.lang.ArrayIndexOutOfBoundsException: // 에러에 대한 종류 명(에러명) -> 배열의 인덱스 범위를 벗어남 : 
		//    Index 4 out of bounds for length 4 //길이를 4칸짜리로 만든 배열인데, 없는 인덱스번호인 4에 접근했다
	...
	public void ex5() {
		// 점심 메뉴 뽑기 프로그램
		String[] arr = {"깁밥", "서브웨이", "햄버거", "백반", "국밥", "짜장면"};
	...
	public void ex6() {
		...
		if( !flag ) { //!부정 연산자:논리 값을 반대로 바꾸어주는 연산자
					  //초기 flag 값이 true이면 부정연산아 없어도 된다 
	...
	public void ex8() {
		...
		// hello world 도 수집 가능
		// [h, o, l, l, o, , w, o, r, l, d]-> 공백도 들어온다
		
		// 1. 입력받은 문자열을 한글자씩 잘라내어 
		//      char 배열에 순서대로 저장
		// 1-1) 입력받은 문자열 길이 만큼의 char 배열 선언 및 할당하기
