...
public class BasicPhone_Re extends Phone_Re{
	
	private boolean hasPhysicalKeyboard;
	
	
	public BasicPhone_Re() {}


	public BasicPhone_Re(String brand, String model, int year, int price, boolean hasPhysicalKeyboard) {
